                ...
                <div class="col-md-3">
                    ...
                    <div class="box box-primary">
                        <div class="box-body box-profile">
                            <h3 class="profile-username text-center">${vehicle.constructeur} (${vehicle.nbPlaces} places)</h3>
                            ...
                            <ul class="list-group list-group-unbordered">
                                ...
                                <li class="list-group-item">
                                    <b>Clients(s)</b> <a class="pull-right">3</a>
                                </li>
                            </ul>
                        </div>
                        <!-- /.box-body -->
                                ...
                                <div class="box-body no-padding">
                                    <table class="table table-striped">
                                        <tr>
                                            ...
                                            <th>Prenom</th>
                                            <th>Email</th>
                                            <th style=>dateNaissance</th>
                                        </tr>
                                        <c:forEach items="${rents}" var="rent">
                                            <tr>
                                                <td>${rent.client.cle}</td>
                                                <td>${rent.client.nom}</td>
                                                <td>${rent.client.prenom}</td>
                                                <td>${rent.client.email}</td>
                                                <td>${rent.client.dateNaissance}</td>
                                            </tr>
                                        </c:forEach>
                                    </table>
                                </div>
